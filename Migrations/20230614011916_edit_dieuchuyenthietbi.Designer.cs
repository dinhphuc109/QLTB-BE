...
namespace NETCORE3.Migrations
{
    ...
    [Migration("20230614011916_edit_dieuchuyenthietbi")]
    partial class edit_dieuchuyenthietbi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NETCORE3.Models.BanGiaoTB", b =>
                {
                    ...
                    b.Property<Guid?>("UserGiao_Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("UserNhan_Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NETCORE3.Models.BanGiao_ThongTinThietBi", b =>
                {
                    ...
                    b.Property<Guid?>("TinhTrangThietBi_Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TinhTrangThietBi_Id");
            ...
            modelBuilder.Entity("NETCORE3.Models.DanhMucLoi", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NETCORE3.Models.HinhThucCapPhat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MaHinhThucCapPhat")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("TenHinhThucCapPhat")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
            ...
            modelBuilder.Entity("NETCORE3.Models.TieuChuanBaoTri", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MaTieuChuanBaoTri")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("QuyDinh_TaiLieuHuongDan")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<string>("TenTieuChuanBaoTri")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<DateTime>("ThoiGianTieuChuanBaoTri")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("TieuChuanBaoTris");
                });

            modelBuilder.Entity("NETCORE3.Models.TinhTrangThietBi", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MaTinhTrangThietBi")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("TenTinhTrangThietBi")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
            ...
            modelBuilder.Entity("NETCORE3.Models.BanGiao_ThongTinThietBi", b =>
                {
                    ...
                    b.HasOne("NETCORE3.Models.TinhTrangThietBi", "TinhTrangThietBi")
                        .WithMany()
                        .HasForeignKey("TinhTrangThietBi_Id")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("NETCORE3.Models.ChucVu", b =>
                {
                    b.HasOne("NETCORE3.Models.BoPhan", null)
                        .WithMany("ChucVus")
            ...
            modelBuilder.Entity("NETCORE3.Models.DieuChuyenNhanVien", b =>
                {
                    ...
                    b.HasOne("NETCORE3.Models.DonVi", "DonViTraLuong")
                        .WithMany()
                        .HasForeignKey("DonViTraLuongId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("NETCORE3.Models.DonVi", "DonViTraLuongNew")
                        .WithMany()
